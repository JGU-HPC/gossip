...
for i, plan in enumerate(plans[args.arch]):
    ...
    p1 = subprocess.Popen(
        [
            args.python,
            base_path + "/benchmark/benchmark_plan.py",
            "all2all",
            plan,
            "-o",
            args.dir + "/" + plan_label + "_all2all.csv",
        ]
    ).wait()
    print("\tall2all_async")
    p2 = subprocess.Popen(
        [
            ...
            plan,
            "-o",
            args.dir + "/" + plan_label + "_all2all_async.csv",
        ]
    ).wait()
...
subprocess.Popen(
    [
        args.python,
        base_path + "/benchmark/plot_results.py",
        "-o",
        args.dir + "/" + args.arch + "_all2all_benchmark.pdf",
        args.dir + "/*",
    ]
).wait()
